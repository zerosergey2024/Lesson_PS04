...
if choice == '1':
    ...
    # Запрос пользователю о листании параграфов
    answer = input("Хотите ли вы пролистать параграфы на странице, на которую перейдете? (да/нет): ")

    if answer.lower() == "да":
        browser.get(link)
        for i in range(5):  # Листаем 5 раз
